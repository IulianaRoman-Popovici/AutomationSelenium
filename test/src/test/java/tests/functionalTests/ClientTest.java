...
public class ClientTest extends AbstractTestClass {
    ...
    public static void setUp() {
        ...
        consoleApplicationPage = ambassadorSystemHomePage.clickLoginButtonOnHomePage()
                .fillInEmail("qaClientAmbassadorSystems@gmail.com")
    ...
    public void testConsoleApplicationInformation(){
        ...
        Assert.assertTrue("Error: Client name is not displayed in dashboard and should be", consoleApplicationPage.isNameInDashboardSelected("Platinum Lender"));
