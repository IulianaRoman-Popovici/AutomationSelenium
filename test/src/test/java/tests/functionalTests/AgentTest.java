...
public class AgentTest extends AbstractTestClass {
    ...
    public void testConsoleApplicationInformation(){
        ...
        Assert.assertTrue("Error: Lender is not displayed in list and should be", consoleApplicationPage.isValuePresentInDropDown("qaLenderAmbassadorSystems@gmail.com"));
        ...
        Assert.assertTrue("Error: Lender name is not displayed in dashboard and should be", consoleApplicationPage.isNameInDashboardSelected("Platinum Lender"));
    ...
    public void testBuySellPlansInformation(){
        ...
        Assert.assertTrue("Error: The name displayed in the header is not correct", buySellAllPlansPage.isHeaderNameCorrect("Client QA"));
